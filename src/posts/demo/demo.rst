...
cannot uniquely refer to either of them by name.  If we try to, an
error is generated.
...
.. image:: {attach}title.png
   :target: directives_

A figure directive:

.. figure:: {attach}title.png
...
.. |EXAMPLE| image:: {attach}biohazard.png
...
Any errors caught during processing will generate system messages.  However,
Pelican fails to build a site when its pages produce any errors or warnings, so
the six errors in this document had to be edited out before the document could
